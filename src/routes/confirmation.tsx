            ...
            <div className="flex flex-col gap-8">
              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="text-center flex flex-col gap-1">
                  <h1 className="font-normal text-gray-900" style={{ fontSize: '20px' }}>
              ...
              {appointmentData.eventStartTime && (
                <div 
                  className="bg-blue-50 rounded px-10 py-6 flex items-center gap-2"
                >
                  <svg className="w-6 h-6 flex-shrink-0 text-gray-700" fill="none" stroke="currentColor" viewBox="0 0 24 24" style={{ opacity: 0.8 }}>
