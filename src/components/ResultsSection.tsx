        ...
        <div className={`mb-16 animate-on-scroll ${isIntersecting ? 'animate animate-fade-in-up animate-delay-200' : ''}`}>
          ...
          <div className="hidden lg:block">
            <div className="grid grid-cols-2 gap-12">
              ...
              <div className="bg-white dark:bg-gray-700 rounded-3xl p-8 shadow-sm border border-gray-200 dark:border-gray-600">
                ...
                <h3 className="font-semibold text-gray-900 dark:text-white mb-3">Attract more guests</h3>
              ...
              <div className="bg-blue-600 dark:bg-blue-700 rounded-3xl p-8 text-white shadow-sm">
              ...
              <div className="bg-white dark:bg-gray-700 rounded-3xl p-8 shadow-sm border border-gray-200 dark:border-gray-600">
                ...
                <h3 className="font-semibold text-gray-900 dark:text-white mb-3">Grow Avg. Ticket Size</h3>
                <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
              ...
              <div className="bg-gray-200 dark:bg-gray-600 rounded-3xl p-8 shadow-sm">
                <div className="w-12 h-12 bg-blue-100 dark:bg-blue-900 rounded-lg flex items-center justify-center mb-4">
                  <svg className="w-6 h-6 text-blue-600 dark:text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
                  </svg>
                </div>
                <h3 className="font-semibold text-gray-900 dark:text-white mb-3">Simple & Fast</h3>
                <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
          ...
          <div className="lg:hidden grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-white dark:bg-gray-700 rounded-lg p-6 shadow-sm border border-gray-200 dark:border-gray-600">
              ...
              <h3 className="font-semibold text-gray-900 dark:text-white mb-2">Attract more guests</h3>
              <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                With LocalSpot, restaurants attract more diners through Google, social media, and reservations — making them the best choice when guests are deciding where to eat.
              </p>
            </div>
            ...
            {/* Top Right - Bring first-time visitors back */}
            <div className="bg-blue-600 dark:bg-blue-700 rounded-lg p-6 text-white shadow-sm">
              <div className="w-10 h-10 bg-blue-500 dark:bg-blue-600 rounded-lg flex items-center justify-center mb-4">
            ...
            <div className="bg-white dark:bg-gray-700 rounded-lg p-6 shadow-sm border border-gray-200 dark:border-gray-600">
              ...
              <h3 className="font-semibold text-gray-900 dark:text-white mb-2">Grow Avg. Ticket Size</h3>
              <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                Menus with photos and pairing suggestions sell more. LocalSpot restaurants see 10-25% higher checks and up to 50% more sales on featured dishes.
              </p>
            </div>
            ...
            <div className="bg-white dark:bg-gray-700 rounded-lg p-6 shadow-sm border border-gray-200 dark:border-gray-600">
              ...
              <h3 className="font-semibold text-gray-900 dark:text-white mb-2">Simple & Fast</h3>
              <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                Menus load in under 2 seconds, most restaurants are live in 7 days, and 95% of staff feel comfortable using the dashboard within minutes.
              </p>
            </div>
