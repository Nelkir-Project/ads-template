          ...
          <div className="hidden lg:block">
            <div className="grid grid-cols-2 gap-12">
              ...
              <div className="bg-white rounded-3xl p-8 shadow-sm border border-gray-200">
                ...
                <h3 className="font-semibold text-gray-900 mb-3">Attract more guests</h3>
              ...
              <div className="bg-white rounded-3xl p-8 shadow-sm border border-gray-200">
                ...
                <h3 className="font-semibold text-gray-900 mb-3">Grow Avg. Ticket Size</h3>
                <p className="text-gray-600 leading-relaxed">
              ...
              <div className="bg-gray-200 rounded-3xl p-8 shadow-sm">
                ...
                <h3 className="font-semibold text-gray-900 mb-3">Simple & Fast</h3>
                <p className="text-gray-600 leading-relaxed">
