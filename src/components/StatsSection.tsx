    ...
    <section className="bg-gray-50 py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 uppercase tracking-wide font-semibold">UPDATED DAILY</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600">Reclaimed wasted spend across all accounts</p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600">Median time to ROI</p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600">PPC Pros</p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600">Per paid customer</p>
          </div>
        ...
        <div className="text-center mt-12">
          <div className="heading-text text-5xl font-bold text-gray-900 mb-2">$12.8M</div>
          <h3 className="font-semibold text-gray-900 mb-1">Connected Monthly Ad Spend</h3>
